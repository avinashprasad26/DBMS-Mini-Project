          ...
          <table class="table">
            ...
            while($rows=mysqli_fetch_assoc($data))
            {
              ...
              <tr>
                ...
                <td><a href="Edit_pharmcy.php?ii=<?php echo $rows['drug_id']; ?>" data-bs-toggle="tooltip" title="Update"><i class="fas fa-edit" aria-hidden="true"></i></a></td>
                <td><a href="delete_pharmacy.php?ii=<?php echo $rows['drug_id']; ?>" onclick="return checkdelete()" data-bs-toggle="tooltip" title="Delete"><i class="fas fa-trash" aria-hidden="true"></i></a></td>
              </tr>
              <script>
