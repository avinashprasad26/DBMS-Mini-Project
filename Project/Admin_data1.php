    ...
    <div class="wrapper">
      <div class="top_navbar">
        ...
        <div class="top_menu">
          ...
          echo"Welcome to Admin ".$_SESSION["user_name"];}
          ?></div>
      ...
      <div class="sidebar">
        <ul>
          ...
          <li><a href="#" class="active"><span class="icon"><i class="fas fa-user" aria-hidden: "true"></i></span><span class="title">Profile</span></a></li>
            <li><a href="Doctors_Record.php"><span class="icon"><i class="fas fa-user-md" aria-hidden: "true"></i></span><span class="title">Doctors Records</span></a></li>
            <li><a href="Add_Doctors.html"><span class="icon"><i class="fas fa-user-plus" aria-hidden: "true"></i></span><span class="title">Add Doctors</span></a></li>
              <li><a href="patient_record.php"><span class="icon"><i class="fas fa-user-injured" aria-hidden: "true"></i></span><span class="title">Patient</span></a></li>
              <li><a href="appointment_records.php"><span class="icon"><i class="far fa-calendar-check" aria-hidden: "true"></i></span><span class="title">Appointment</span></a></li>
              <li><a href="pharmacey.php"><span class="icon"><i class="fas fa-book-medical" aria-hidden: "true"></i></span><span class="title">Pharmacy</span></a></li>
              <li><a href="Add_pharmacy.php"><span class="icon"><i class="fas fa-laptop-medical" aria-hidden: "true"></i></span><span class="title">Add Pharmacy</span></a></li>
        </ul>
      </div>
...
<div class="container">
  <div class="item">
    <form class="form" action="index.html" method="post">
      <h1 style="text-align:center">Admin Profile</h1><br><br>
