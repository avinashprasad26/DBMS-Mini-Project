...
$query = "select * from appointment a, doctorlog d,patientlog p where a.pid=p.id and a.doc_id=d.id and d.username='$d'";
...
<link href="https://fonts.googleapis.com/css2?family=Lobster&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container">
      <h1>Appointment Records of your <br>Patient</h1>
          ...
          <table class="table">
            ...
            while($rows=mysqli_fetch_assoc($data))
            {
              ...
              <tr>
                ...
                <td><a href="delete2.php?ii=<?php echo $rows['app_id']; ?>" onclick="return checkdelete()" data-bs-toggle="tooltip" title="Delete"><i class="fas fa-trash" aria-hidden="true"></i></a></td>
              </tr>
              <script>
